...
Reference full template: `/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/templates/state.md`.
