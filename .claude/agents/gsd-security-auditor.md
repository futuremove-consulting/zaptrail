...
**Verification depth scales with `asvs_level`** (see @/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
