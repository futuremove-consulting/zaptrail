...
<reference>
@/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/references/user-profiling.md` to load:
