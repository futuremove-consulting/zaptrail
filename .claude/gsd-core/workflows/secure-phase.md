...
```
Agent(
  prompt="Read /home/rochagus/projetos-linux/zaptrail/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/templates/SECURITY.md`
