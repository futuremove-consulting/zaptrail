...
- **Global scope**: `/home/rochagus/projetos-linux/zaptrail/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/rochagus/projetos-linux/zaptrail/.claude/notes/`)
...
2. Glob `/home/rochagus/projetos-linux/zaptrail/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/rochagus/projetos-linux/zaptrail/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/rochagus/projetos-linux/zaptrail/.claude/notes/` — works in any directory
