...
ones). Reference: @/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/rochagus/projetos-linux/zaptrail/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/rochagus/projetos-linux/zaptrail/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/templates/spec.md.
