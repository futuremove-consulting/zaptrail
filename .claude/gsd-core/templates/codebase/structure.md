...
- Usage: Reference from command with `@/home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/rochagus/projetos-linux/zaptrail/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/rochagus/projetos-linux/zaptrail/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
