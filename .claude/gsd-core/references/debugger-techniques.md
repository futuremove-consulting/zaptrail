...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/rochagus/projetos-linux/zaptrail/.claude
                  → checks /home/rochagus/projetos-linux/zaptrail/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/rochagus/projetos-linux/zaptrail/.claude/gsd-core
                  → writes to /home/rochagus/projetos-linux/zaptrail/.claude/gsd-core/hooks/
